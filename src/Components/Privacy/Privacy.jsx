...
import './Privacy.css'
import privacyus from '../Assets/footbaner.jpg'
import banner from '../Assets/privacy.jpg'
import video from '../Assets/privacyvid.mp4'

const Privacy = () => {
    return (
        <div className='privacy'>
            <div className="privacyus">
                <div className="privacyus-left">
                    <h2>#Privacy</h2>
                </div>
                <div className="privacyus-right">
                    {<img src={privacyus} alt="" />}
                </div>
            </div>
